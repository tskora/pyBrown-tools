...
from pyBrown.input_Clusters import InputDataClusters
...
def main(input_filename):
	...
	i = InputDataClusters(input_filename, required_keywords, defaults)
	...
	timestamp( 'Computing time-dependent distance mattrices' )
	compute_distance_matrices(i.input_data, times, cm_labels, auxiliary_data)
